...
@section('content')
    <div class="row">
        ...
        <!-- <div class="col" >
            <div class="card" style="backg-round-color: #3ade9f; font-size:20px;">
                <div class="card-body text-center text-white">
                    <a href="{{ route('vue.liste.contact') }}">Annuaire</a>
                </div>
                <div class="card-footer text-center text-white" style="background-color: #272d69">
                {{ $contact ?? 0 }}
                </div>
        ...
        <!-- <div class="row">
            <div class="col" >
                <div class="card" style="backg-round-color: #3ade9f; font-size:20px;">
                    <div class="card-body text-center text-white">
                        <a href="{{ route('vue.liste.contact') }}">{{ $nombreDeContactEnFavorisTotal > 1 ? "Contacts Favoris Total" : "Favori" }}</a>
                    </div>
                    <div class="card-footer text-center text-white" style="background-color: #272d69">
                    {{ $nombreDeContactEnFavorisTotal ?? 0 }}
                    </div>
                </div>
            </div>
        </div> -->
