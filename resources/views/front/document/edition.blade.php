...
@section('title', 'Interface de modification de document')
@push('styles')
...
@section('content')
    ...
    <div class="container" style="padding-bottom: 2em; padding-top: 1em">
        ...
        <div class="row col-sm-6">
            <form method="post" action="{{ route('modifier.document')}}" autocomplete="on" enctype="multipart/form-data">
                <input type="hidden" name="documentId" value="{{$documentInfo->id}}">
                @csrf
                <div class="card">
                            ...
                            <div class="row" style="padding-bottom:1em">
                                <div class="col-sm-12" style="padding-bottom:1em">
                                    <div class="form-group">
                                        ...
                                        <input required="required" value="{{ $documentInfo->titre }}" name="titre" type="text" class="form-control" name="titre" placeholder="Titre du document"> 
                                ...
                                <div class="row" style="padding-bottom:1em">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="date" value="{{ $documentInfo->date_cloture }}" name="date_cloture" required="required" name="date_cloture" id="date_cloture" class="form-control input-md">                                    <span class="text-danger">@error('email'){{$message}} @enderror</span>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label for="tel"><b>Niveau de pertinance</b> </label>
                                        <select {{ $documentInfo->pertinance }}" name="pertinance" class="form-control input-md" required="required" required="required">
