...
@section('content')
    @section('titlePage')  <h1 class="m-0">Modifition du profil</h1> @stop
    <div class="container">
                       ...
                       <div class="card">
                            <div class="card-body">
                                <div class="row container">
                                    <form action="{{ route('admin.modifier.utilisateur', $utilisateurTrouver->id) }}" method="post">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 form-group">
                                                        ...
                                                        <input type="hidden" value="{{ $utilisateurTrouver->code ? $utilisateurTrouver->code : '' }}"  placeholder="Code barreau" name="code" class="form-control">
                                                    ...
                                                    <div class="col-sm-6 form-group">
                                                        ...
                                                        <input type="hidden" value="{{ $utilisateurTrouver->matricule ? $utilisateurTrouver->matricule : '' }}"  placeholder="0GD02024" name="matricule" class="form-control">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 form-group">
                                                        ...
                                                        <select name="sexe" id="sexe" value="{{ $utilisateurTrouver->sexe ? $utilisateurTrouver->sexe : '' }}" class="form-control">
                                                    ...
                                                    <div class="col-sm-6 form-group">
                                                        ...
                                                        <input type="text" value="{{ $utilisateurTrouver->telephone ? $utilisateurTrouver->telephone : '' }}" name="telephone" placeholder="(+225) xxxxxxxx" id="telephone" class="form-control">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 form-group">
                                                        ...
                                                        <select name="role" value="{{ $utilisateurTrouver->role ? $utilisateurTrouver->role : '' }}" class="form-control" id="role">
                                                            ...
                                                            <option value="user" {{ $utilisateurTrouver->role == 'user' ? 'selected' : '' }}>Elève Avocat</option>
                                                        </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 form-group">
                                                        ...
                                                        <input type="date" value="{{ $utilisateurTrouver->date_prestation ? $utilisateurTrouver->date_prestation : '' }}" name="date_prestation" placeholder="JJ/MM/YYYY" id="dateMask" class="form-control">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 form-group">
                                                        ...
                                                        <input id="phone" type="tel" name="num_toge" placeholder="N°" class="form-control">
