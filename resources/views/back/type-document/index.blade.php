...
@section('title', "Interface ajout type de document")

@section('content')
    @section('titlePage')  <h1 class="m-0">Liste des types de document</h1> @stop
                            ...
                            <div class="card-header p-0 pt-1">
                                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                    <li class="nav-item">
                                        ...
                                        role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Listes des types de document</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-one-tabContent">
                                    <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                        ...
                                        <br>
                                        <div class="row">
                                            <table class="table table-striped nowrap" id="liste_type_document">
                                                <thead>
                                                    <tr>
                                                        <th>N°</th>
                                                        <th>NOM FICHIER</th> 
...
@section('footer')
    ...
    <script>
        ...
        $(document).ready(function(){
            if ($.fn.DataTable.isDataTable('#liste_type_document')) {
                $('#liste_type_document').DataTable().destroy();
            }
            var oTable = $('#liste_type_document').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{!! route('charger.liste.typedocument') !!}",
                columns: [
