...
@section('title', "Interface ajout de model d'acte")

@section('content')
    @section('titlePage')  <h1 class="m-0">Liste des models d'actes</h1> @stop
                            ...
                            <div class="card-header p-0 pt-1">
                                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                    <li class="nav-item">
                                        ...
                                        role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Listes des actes</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-one-tabContent">
                                    <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                        ...
                                        <br>
                                        <div class="row">
                                            <table class="table table-striped nowrap" id="liste_actes">
                                                <thead>
                                                    <tr>
                                                        <th>N°</th>
                                                        <th>NOM FICHIER</th> 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Ajouter un model d'acte</h4>
...
@section('footer')
    ...
    <script>
        ...
        $(document).ready(function(){
            if ($.fn.DataTable.isDataTable('#liste_actes')) {
                $('#liste_actes').DataTable().destroy();
            }
            var oTable = $('#liste_actes').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{!! route('charger.liste.modelacte') !!}",
                columns: [
